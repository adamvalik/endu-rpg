...
export function StatsCard({ userProfile }: StatsCardProps) {
    ...
    return (
        <div className="card bg-[var(--color-pastel-blue)] mb-6">
            <h2 className="text-2xl font-black mb-4 font-tiny5 border-b-3 border-black pb-2">
                LIFETIME STATS
            </h2>

            <div className="grid grid-cols-2 gap-4">
                <div className="bg-white neo-border p-3 neo-shadow-sm flex flex-col items-center">
                ...
                <div className="bg-[var(--color-pastel-yellow)] neo-border p-3 neo-shadow-sm flex flex-col items-center">
                ...
                <div className="bg-[#fbcfe8] neo-border p-3 neo-shadow-sm flex flex-col items-center">
