...
import { getGameProfile, getUserProfile } from '../services/firebase';
import { GameProfile, UserProfile } from '../types';
  ...
  return (
    <SafeAreaView style={styles.container}>
      {activeTab === 'hero' ? (
        ...
        <JournalScreen onSyncComplete={() => loadData(false)} />
      )}
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <Text style={[styles.navText, activeTab === 'hero' && styles.navTextActive]}>Hero</Text>
        </TouchableOpacity>
        <TouchableOpacity
